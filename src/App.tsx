...
export default function App() {
  ...
  return (
    <div id="app-container" className="min-h-screen bg-[#060b16] text-slate-100 flex flex-col font-sans">
      
      {/* PROFESSIONAL UPPER BAR: HACTECH LMS BRAND BANNER */}
      <header id="hactech-header" className="bg-[#0b1324] border-b border-slate-800 shadow-sm relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-80 h-40 bg-gradient-to-r from-blue-500/10 to-transparent blur-3xl pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-4 py-5 flex flex-col md:flex-row items-center justify-between gap-4 relative z-10">
          ...
          <div className="flex items-center space-x-3.5">
            <div className="bg-gradient-to-br from-amber-500 to-amber-600 p-2.5 rounded-xl text-slate-900 shadow-md">
              <School className="w-7 h-7" />
            </div>
            <div>
              <div className="flex items-center space-x-2">
                <span className="bg-amber-500/10 text-amber-500 border border-amber-500/20 font-mono text-[9px] uppercase px-2 py-0.5 rounded font-black tracking-wider">
                  HACTECH SYNC
                </span>
                <span className="text-slate-500 text-xs font-mono">• lms platform</span>
              </div>
              <h1 className="font-sans font-bold text-white text-lg lg:text-xl tracking-tight mt-0.5">
          ...
          <div className="flex items-center space-x-4">
            <div className="hidden sm:flex items-center space-x-2 bg-slate-900/80 border border-slate-800/80 p-2 rounded-lg">
              <Award className="w-4 h-4 text-amber-500" />
              <div className="text-[10px] font-mono text-slate-350">
                <span className="block text-slate-400 font-semibold font-sans leading-none">Chất lượng cao</span>
                <span className="leading-none mt-1 block">Xưởng Thực Hành K15 / K16</span>
              </div>
            </div>
            ...
            <a
              ...
              className="bg-amber-500 hover:bg-amber-600 text-slate-950 px-3.5 py-2 rounded-lg text-xs font-semibold flex items-center space-x-1 transition-all shadow hover:shadow-lg"
            >
      ...
      <main id="app-main-content" className="flex-1 max-w-7xl w-full mx-auto px-4 py-8 flex flex-col space-y-8">
        ...
        {/* TABS SELECTOR PANEL */}
        <div id="tabs-group" className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 border-b border-slate-800/80 pb-4">
          
          <div className="flex items-center bg-[#0b1324] border border-slate-800 rounded-xl p-1 gap-1">
            <button
              type="button"
          ...
          <div id="quick-tip-banner" className="hidden lg:flex items-center space-x-2 text-[10px] text-slate-400 font-mono italic">
      ...
      <footer id="hactech-footer" className="bg-[#0b1324] border-t border-slate-800 text-slate-400 py-10 mt-16 text-center text-xs space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="text-[11px] text-slate-350 space-y-1">
              <p className="flex items-center space-x-1">
                ...
                <a href="https://keypremiumshop.com" target="_blank" referrerPolicy="no-referrer" className="hover:text-amber-500 hover:underline">keypremiumshop.com</a>
              </p>
              <p className="flex items-center space-x-1">
